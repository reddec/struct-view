...
type Config struct {
	...
	Type     string `short:"v" long:"value-type" env:"VALUE_TYPE" description:"Payload type" required:"yes"`
	Import   string `short:"I" long:"value-import" env:"VALUE_IMPORT" description:"Import for value type"`
...
func main() {
	...
	ev := structview.ChainGen{
		TypeName:    config.TypeName,
		ContextType: config.Type,
	...
	_, _ = output.WriteString("// Code generated by chain-gen. DO NOT EDIT.\n")
